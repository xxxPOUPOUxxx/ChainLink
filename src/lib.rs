...
#[derive(Debug)]
pub struct ChainLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainLink processing");
    
    let mut processor = ChainLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainLinkProcessor::new(false);
